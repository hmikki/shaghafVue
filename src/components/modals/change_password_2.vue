<template>
    ...
    <div class="modal fade change-pas change-password-2" id="exampleModalCenter-6" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
